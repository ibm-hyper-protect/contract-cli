...
1. Go to the [Security tab](https://github.com/ibm-hyper-protect/contract-cli/security) of this repository
...
1. **Keep Dependencies Updated**
   - Regularly update to the latest version of `contract-cli`
...
3. **Validate Input**
   ...
   - Use the provided validation features (`validate-contract`, `validate-network`)
...
The CLI tool downloads encryption certificates from IBM Cloud by default:
...
This CLI tool performs cryptographic operations including:
...
- **Releases** - Check the [Releases page](https://github.com/ibm-hyper-protect/contract-cli/releases) for security patches
...
2. Check existing [security advisories](https://github.com/ibm-hyper-protect/contract-cli/security/advisories)
